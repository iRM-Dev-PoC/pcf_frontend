            ...
            >
                    ...
                    <TableCell>
                        <Label className="boldText">
                            {Number(data.exobj[showDataFor]?.High.sod_name) +
                                Number(
                                    data.exobj[showDataFor]?.Medium.sod_name
                                ) || 0}
                            <br />
                            <span>{bottomValue}%</span>
                        </Label>
                ...
                <TableRow className="text-center">
                    ...
                    <TableCell>
                        <Label className="boldText">
                            <span>
                                {data.exobj[showDataFor]?.Sensitive.role_name ||
                                    0}
                            </span>
                            <br />
                            <span>{bottomValue}%</span>
                ...
                <TableRow className="text-center">
                    ...
                    <TableCell>
                        <Label className="boldText">
                            <span>
                                {Number(
                                    data.exobj[showDataFor]?.High.instances
                                ) +
                                    Number(
                                        data.exobj[showDataFor]?.Medium
                                            .instances
                                    ) || 0}
                            </span>
                            <br />
                    ...
                    <TableCell>
                        <Label className="boldText text-center">
                            <span>
                                {data.exobj[showDataFor]?.Sensitive.instances ||
                                    0}
                            </span>
                            <br />
                            <span>{bottomValue}%</span>
