...
const AddUsers = () => {
	...
	const [selectedUser, setSelectedUser] = useState<getAllUserData | undefined>(
		undefined
	);
		...
		<FlexibleColumnLayout
			...
			midColumn={
				<>
								...
								showDeleteConfirmation({
									onClose(event) {
										if (event.detail.action === "Delete") {
											handleDeleteUser(selectedUser ? selectedUser.ID : 0);
										}
									},
									type: MessageBoxTypes.Warning,
									actions: [MessageBoxActions.Delete, MessageBoxActions.Cancel],

									children: "Are sure you want to delete this user?",
								});
							}}
						/>
						<Button
					...
					<Toolbar key={selectedUser?.ID} style={{ height: "200px" }}>
						<Avatar
						...
						{isEdit && (
							<Card>
								<UserEditForm
									...
									email={selectedUser ? selectedUser.USER_EMAIL : ""}
